...
bl_info = {
    "name": "Strawberry Wavefront OBJ format",
    "author": "Campbell Barton, Bastien Montagne",
    "version": (2, 3, 6),
    "blender": (2, 78, 0),
    "location": "File > Import-Export",
    "description": "Strawberry Import-Export OBJ, Import OBJ mesh, UV's, materials and textures",
    "warning": "",
...
def menu_func_import(self, context):
    self.layout.operator(ImportOBJ.bl_idname, text="Strawberry Wavefront (.obj)")


def menu_func_export(self, context):
    self.layout.operator(ExportOBJ.bl_idname, text="Strawberry Wavefront (.obj)")
